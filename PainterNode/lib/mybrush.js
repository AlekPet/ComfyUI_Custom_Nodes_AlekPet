...
(function (window, undefined) {
  ...
  function MypaintSurface(divname) {
    ...
    this.draw_dab = function (
      ...
      if (hardness < 1) {
        ...
        g1.addColorStop(
          hardness,
          "rgba(" + rr + "," + gg + "," + bb + "," + opaque + ")"
        );
        g1.addColorStop(1, "rgba(" + rr + "," + gg + "," + bb + ",0)");
      } else {
        var g1 = "rgba(" + rr + "," + gg + "," + bb + "," + opaque + ")";
      }
  ...
  MypaintBrush.prototype.update_states_and_setting_values = function (
    step_dx,
    step_dy,
    step_dpressure,
    step_declination,
  ...
  MypaintBrush.prototype.stroke_to = function (
    surface,
    x,
    y,
    pressure,
