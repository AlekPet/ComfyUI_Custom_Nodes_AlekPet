...
| [**ChatGLMVideoGenerateNode**](https://github.com/AlekPet/ComfyUI_Custom_Nodes_AlekPet/tree/master/ChatGLMNode)                  |                       This is a node that generates an video based on a text prompt or image.                        |    AlekPet Node/video     |
