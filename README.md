...
| [**DeepLXTranslateTextNode**](https://github.com/AlekPet/ComfyUI_Custom_Nodes_AlekPet/tree/master/DeepLXTranslateNode)           |    The node translate promt uses **DeepLX** server written for Golang(Go) from other languages into english and return string     |     AlekPet Node/text     |
| [**DeepLXTranslateCLIPTextEncodeNode**](https://github.com/AlekPet/ComfyUI_Custom_Nodes_AlekPet/tree/master/DeepLXTranslateNode) | The node translate promt uses **DeepLX** server written for Golang(Go) from other languages into english, and return conditioning | AlekPet Node/conditioning |
...
| [**ChatGLM4TranslateTextNode**](https://github.com/AlekPet/ComfyUI_Custom_Nodes_AlekPet/tree/master/ChatGLMNodee)                |                     This translator node uses artificial intelligence to translate prompts and return string                      |     AlekPet Node/text     |
