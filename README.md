...
| [**PainterNode**](https://github.com/AlekPet/ComfyUI_Custom_Nodes_AlekPet/tree/master/PainterNode)                               |                            The node set sketch, scribble image ControlNet and other nodes                            |    AlekPet Node/image     |
| [**GoogleTranslateTextNode**](https://github.com/AlekPet/ComfyUI_Custom_Nodes_AlekPet/tree/master/GoogleTranslateNode)           |       The node translate prompt uses module **googletrans** from other languages into english and return string       | AlekPet Node/conditioning |
| [**GoogleTranslateCLIPTextEncodeNode**](https://github.com/AlekPet/ComfyUI_Custom_Nodes_AlekPet/tree/master/GoogleTranslateNode) |   The node translate prompt uses module **googletrans** from other languages into english, and return conditioning    |     AlekPet Node/text     |
| [**DeepTranslatorTextNode**](https://github.com/AlekPet/ComfyUI_Custom_Nodes_AlekPet/tree/master/DeepTranslatorNode)             |     The node translate prompt uses module **Deep Translator** from other languages into english and return string     |     AlekPet Node/text     |
| [**DeepTranslatorCLIPTextEncodeNode**](https://github.com/AlekPet/ComfyUI_Custom_Nodes_AlekPet/tree/master/DeepTranslatorNode)   | The node translate prompt uses module **Deep Translator** from other languages into english, and return conditioning  | AlekPet Node/conditioning |
| [**ArgosTranslateTextNode**](https://github.com/AlekPet/ComfyUI_Custom_Nodes_AlekPet/tree/master/ArgosTranslateNode)             |    The node translate prompt uses module **Argos Translator** from other languages into english and return string     |     AlekPet Node/text     |
| [**ArgosTranslateCLIPTextEncodeNode**](https://github.com/AlekPet/ComfyUI_Custom_Nodes_AlekPet/tree/master/ArgosTranslateNode)   | The node translate prompt uses module **Argos Translator** from other languages into english, and return conditioning | AlekPet Node/conditioning |
...
| [**ChatGLMImageGenerateNode**](https://github.com/AlekPet/ComfyUI_Custom_Nodes_AlekPet/tree/master/ChatGLMNode)                  |                            This is a node that generates an image based on a text prompt                             |    AlekPet Node/image     |
| [**ChatGLMVideoGenerateNode**](https://github.com/AlekPet/ComfyUI_Custom_Nodes_AlekPet/tree/master/ChatGLMNode)                  |                       This is a node that generates a video based on a text prompt or image.                        |    AlekPet Node/video     |
...
1. Download from github repository ComfyUI_Custom_Nodes_AlekPet, extract folder ComfyUI_Custom_Nodes_AlekPet, and put in custom_nodes
...
2. Run Comfyui and nodes will be installed automatically....
